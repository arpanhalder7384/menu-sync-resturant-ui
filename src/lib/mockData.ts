  ...
  REST001: {
    ...
    menu: [
      ...
      },
      {
        ...
        price: 40,
        image: "https://media.istockphoto.com/id/1209656661/photo/famous-bengali-sweet-rasgulla-is-ready-to-serve.webp?a=1&b=1&s=612x612&w=0&k=20&c=cgFMw3gErxT-ilwJw5bPsXkNSmw29UB8u22qQ-gTZ6w=",
      ...
      {
        id: "m10",
        nameEn: "Paneer Tikka Wrap",
        nameBn: "পনির টিক্কা র‍্যাপ",
        price: 110,
        image: "https://images.unsplash.com/photo-1591064141234-8184aae3e77b?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        descriptionEn: "Grilled paneer tikka wrapped in soft flatbread with mint chutney and crunchy onions.",
        descriptionBn: "পুদিনার চাটনি এবং কুচকুচে পেঁয়াজ সহ নরম রুটিতে মোড়ানো গ্রিলড পনির টিক্কা।",
        category: "Main",
        isSpecial: false,
        isVeg: true,
        pairingPartnerId: "m6",
        pairingReasonEn: "Best enjoyed with a cold Mango Mojito!",
        pairingReasonBn: "ঠান্ডা ম্যাঙ্গো মোহিতোর সাথে সবচেয়ে ভালো জমে!",
      },
      {
        id: "m11",
        nameEn: "Chocolate Truffle Pastry",
        nameBn: "চকলেট ট্রাফল পেস্ট্রি",
        price: 80,
        image: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=400&q=80",
        descriptionEn: "Decadent layered chocolate cake with rich dark chocolate ganache.",
        descriptionBn: "সমৃদ্ধ ডার্ক চকলেট গানাশ সহ লোভনীয় চকোলেট লেয়ার কেক।",
        category: "Dessert",
        isSpecial: true,
        isVeg: true,
      },
      {
        ...
        nameBn: "পেরি পেরি ফ্রেঞ্চ ফ্রাই",
        price: 95,
        image: "https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=400&q=80",
        descriptionEn: "Crispy golden fries tossed in spicy and tangy Peri Peri seasoning.",
        descriptionBn: "মশলাদার এবং চটকদার পেরি পেরি মশলায় টস করা মুচমুচে ফ্রেঞ্চ ফ্রাই।",
        category: "Starter",
        isSpecial: false,
        isVeg: true,
      },
      {
        ...
        nameBn: "চিকেন চিজ বার্গার",
        price: 130,
        image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=400&q=80",
        descriptionEn: "Juicy chicken patty with melted cheese, fresh lettuce, and burger sauce in toasted buns.",
        descriptionBn: "টোস্ট করা বানের ভেতর গলানো চিজ, তাজা লেটুস এবং বার্গার সস সহ রসালো চিকেন প্যাটি।",
        category: "Main",
        isSpecial: true,
        isVeg: false,
        pairingPartnerId: "m14",
        pairingReasonEn: "Complements perfectly with a chilled Blue Lagoon Mocktail!",
        pairingReasonBn: "ঠান্ডা ব্লু লেগুন মকটেলের সাথে চমৎকার মানায়!",
      },
      {
        id: "m14",
        nameEn: "Blue Lagoon Mocktail",
        nameBn: "ব্লু লেগুন মকটেল",
        price: 85,
        image: "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=400&q=80",
        descriptionEn: "A vibrant blue drink with a refreshing blend of blue curaçao, lime juice, and sprite.",
        descriptionBn: "ব্লু কিউরাসাও, লেবুর রস এবং স্প্রাইটের রিফ্রেশিং ব্লেন্ডের একটি প্রাণবন্ত নীল পানীয়।",
        category: "Drink",
        isSpecial: false,
        isVeg: true,
      },
      {
        ...
        descriptionEn: "Classic espresso shot topped with thick steamed milk foam and cocoa dusting.",
        descriptionBn: "ঘন স্টিমড মিল্ক ফোম এবং কোকো ডাস্টিং সহ ক্লাসিক এসপ্রেসো শট।",
        category: "Drink",
        isSpecial: false,
        isVeg: true,
        pairingPartnerId: "m11",
        pairingReasonEn: "Best enjoyed alongside a slice of Chocolate Truffle Pastry!",
        pairingReasonBn: "চকলেট ট্রাফল পেস্ট্রির টুকরোর সাথে এটি সবচেয়ে দারুণ জমে!",
      }
    ]
  },
  REST002: {
...
export const HASH_MAPPINGS: Record<string, QRMapping> = {
  ...
  "mdbhjsadjasdgjafcvcsj3213h2veg24gh234h": {
    ...
    restaurantNameEn: "Cafe Adda",
    restaurantNameBn: "ক্যাফে আড্ডা",
    tableNumber: "01"
  },
  "cafeadda5678": {
    restaurantId: "REST001",
